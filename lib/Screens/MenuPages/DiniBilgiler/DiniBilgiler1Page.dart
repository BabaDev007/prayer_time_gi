...
class _DiniBilgiler1PageState extends State<DiniBilgiler1Page> {
  ...
  Future<void> getData() async {
    ...
    var res1 = document
        .getElementsByClassName("optionshort2")
      ...
      setState(() {
        movzuAdi.add(ReadFile(
            ...
            element.text.toString().substring(5),
            false,
          ...
          child: BackdropFilter(
            ...
            child: AppBar(
              ...
              title: Text(
                "${widget.bashliq}",
                style: TextStyle(
                    fontFamily: "Oswald", color: Colors.white.withOpacity(.8)),
              ),
            ),
          ),
        ),
                    ...
                    return AnimationConfiguration.staggeredList(
                      ...
                      child: SlideAnimation(
                        ...
                        child: FlipAnimation(
                            ...
                            child: Padding(
                                padding:
                                    PaddingManager().prayerTimeWidgetPadding,
                                child: Container(
