...
SizedBox(width: 10,),
                    Text("Çox mühüm açıqlama", style: TextStyle(fontWeight: FontWeight.bold,  color: Constants.primaryColor ),),
                  ],
                ),
                Row(
       ...
       :   Column(
            ...
            children: [
              ...
              Text("Çox mühüm açıqlama", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.red ),),
              SizedBox(height: 10,),
              Text("Küfrə düşən nə etməlidir?",
                style: TextStyle( fontFamily: "PlayfairDisplay-VariableFont", fontWeight: FontWeight.bold  ),),
              SizedBox(height: 20,),
              Text("Sual",
                style: TextStyle( fontFamily: "PlayfairDisplay-VariableFont", fontWeight: FontWeight.bold  ),),
