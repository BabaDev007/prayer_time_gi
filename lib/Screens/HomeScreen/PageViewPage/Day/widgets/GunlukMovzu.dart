...
class _GunlukMovzuCardState extends State<GunlukMovzuCard> {
  ...
  Widget build(BuildContext context) {
    void _launchUrl(String patha) async {
      if (!await launch(Uri.parse(patha).toString(),
          forceSafariVC: true,
          forceWebView: false)) throw 'Could not launch $patha';
    }
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    box.read("bashliq") ??
                        "Dişdə dolğu və diş qapağının olması",
                    maxLines: 2,
                ...
                Padding(
                  ...
                  child: AnimatedCrossFade(
                    firstChild: Text(
                      maxLines: 2,
                      box.read("metin").toString() ?? Constants().metin,
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.justify,
                      style: TextStyle(
